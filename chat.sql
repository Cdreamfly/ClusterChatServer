...
CREATE TABLE `allgroup` (
  ...
  `groupame` varchar(50) NOT NULL,
  `groupdesc` varchar(200) DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `groupame` (`groupame`)
...
INSERT INTO `user` VALUES (1,'cmf','123456','online'),(2,'ccc','123456','online');
...
-- Dump completed on 2022-05-13 21:18:55